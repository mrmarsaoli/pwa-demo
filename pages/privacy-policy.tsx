...
const PrivacyPolicy: NextPage = () => {
  return (
    <div className="container mx-auto px-4">
      <h2 className="text-4xl font-bold">PRIVACY NOTICE</h2>
      ...
      <div className="text-base text-gray-800">
        <p>
          This privacy notice for Mrmarsaoli (&quote; Company ,&quote;
          &quote;we,&quote; &quote;us,&quote; or &quote;our&quote; ), describes
          how and why we might collect, store, use, and/or share (
          &quote;process&quote;) your information when you use our services
          (&quote;Services&quote;), such as when you:
        </p>
        <ul>
          <li>
            Download and use our mobile application (PWA Demo) , or any other
        ...
        <p>
          ...
          on how you interact with Mrmarsaoli and the Services, the choices you
        ...
        <p>
          Want to learn more about what Mrmarsaoli does with any information we
        ...
        <ol>
          ...
          <li>
            <a href="#">HOW LONG DO WE KEEP YOUR INFORMATION?</a>
          </li>
          <li>
          ...
          <li>
            <a href="#">CONTROLS FOR DO-NOT-TRACK FEATURES</a>
          </li>
          <li>
            <a href="#">
          ...
          <li>
            <a href="#">DO WE MAKE UPDATES TO THIS NOTICE?</a>
          </li>
          <li>
        ...
        1. WHAT INFORMATION DO WE COLLECT? Personal information you disclose to
        us In Short: We collect personal information that you provide to us. We
        ...
        sensitive information. Application Data. If you use our application(s),
        we also may collect the following information if you choose to provide
        us with access or permission: Push Notifications. We may request to send
        you push notifications regarding your account or certain features of the
        ...
        notify us of any changes to such personal information. 2. HOW DO WE
        PROCESS YOUR INFORMATION? In Short: We process your information to
        ...
        how you interact with our Services, including: 3. WHEN AND WITH WHOM DO
        WE SHARE YOUR PERSONAL INFORMATION? In Short: We may share information
        in specific situations described in this section and/or with the
        following third parties. We may need to share your personal information
        ...
        a portion of our business to another company. 4. HOW LONG DO WE KEEP
        YOUR INFORMATION? In Short: We keep your information for as long as
        ...
        than __________ . When we have no ongoing legitimate business need to
        ...
        processing until deletion is possible. 5. HOW DO WE KEEP YOUR
        INFORMATION SAFE? In Short: We aim to protect your personal information
        through a system of organizational and technical security measures. We
        ...
        You should only access the Services within a secure environment. 6. DO
        WE COLLECT INFORMATION FROM MINORS? In Short: We do not knowingly
        ...
        mrmarsaoli@gmail.com . 7. WHAT ARE YOUR PRIVACY RIGHTS? In Short: You
        may review, change, or terminate your account at any time. If you are
        ...
        local data protection supervisory authority. You can find their contact
        details here:
        ...
        details provided in the section &quote; HOW CAN YOU CONTACT US ABOUT
        THIS NOTICE? &quote; below. However, please note that this will not
        ...
        than consent. If you have questions or comments about your privacy
        rights, you may email us at mrmarsaoli@gmail.com. 8. CONTROLS FOR
        DO-NOT-TRACK FEATURES Most web browsers and some mobile operating
        systems and mobile applications include a Do-Not-Track (
        &quote;DNT&quote;) feature or setting you can activate to signal your
        ...
        revised version of this privacy notice. 9. DO CALIFORNIA RESIDENTS HAVE
        SPECIFIC PRIVACY RIGHTS? In Short: Yes, if you are a resident of
        California, you are granted specific rights regarding access to your
        personal information. California Civil Code Section 1798.83, also known
        as the &quote;Shine The Light&quote; law, permits our users who are
        ...
        a registered account with Services, you have the right to request
        ...
        from all our systems (e.g., backups, etc.). 10. DO WE MAKE UPDATES TO
        ...
        &quote;Revised&quote; date and the updated version will be effective as
        ...
        email us at mrmarsaoli@gmail.com or by post to: Mrmarsaoli Jln. Durian 1
        Jati Perumnas Ternate , Maluku Utara 97713 Indonesia 12. HOW CAN YOU
        ...
        form by clicking here . This privacy policy was created using
